...
void Engine::LoadApplicationResources()
{
	...
	bUnitTest = ResourceManager::GetInstance().LoadTextureImagesFromFile("res/Textures/BattleBrian.jpg", "enemySphere"); assert(bUnitTest);
	...
	bUnitTest = ResourceManager::GetInstance().LoadTextureImagesFromFile("res/Textures/cyan.png", "cyan"); assert(bUnitTest);
	...
	{
		"res/Textures/Skyboxes/cloudy/right.jpg", "res/Textures/Skyboxes/cloudy/left.jpg", 
		"res/Textures/Skyboxes/cloudy/top.jpg", "res/Textures/Skyboxes/cloudy/bottom.jpg", 
		"res/Textures/Skyboxes/cloudy/front.jpg", "res/Textures/Skyboxes/cloudy/back.jpg"
	};
